...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		.withClient("dscatalog") //Define o clientId, ou seja o nome da APLICAÇÃO, quando a aplicação WEB for acessar o backEnd ela irá procurar por esse nome definido aqui
		.secret(passwordEncoder.encode("dscatalog123")) //Define o clientSecret, hardCode provisório. Depois será colocado também no arquivo properties
		...
		.accessTokenValiditySeconds(86400); //Define o Tempo de expiração do token em segundos, nesse caso definimos um tempo de 24hrs ou 86400 segundos
	}
